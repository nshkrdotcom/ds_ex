defmodule DSPEx.OptimizedProgram do
  ...
  Used by BEACON to determine enhancement strategy.
  """
  ...
  @doc """
  Determine BEACON enhancement strategy for a program.

  Returns the optimal strategy for enhancing a program with BEACON optimizations:
  ...
  ## Examples
      ...
      iex> DSPEx.OptimizedProgram.beacon_enhancement_strategy(predict)
      :wrap_optimized

      iex> predict_with_demos = %DSPEx.Predict{signature: MySignature, client: :openai, demos: []}
      iex> DSPEx.OptimizedProgram.beacon_enhancement_strategy(predict_with_demos)
      :native_demos

  """
  @spec beacon_enhancement_strategy(struct()) :: :native_full | :native_demos | :wrap_optimized
  def beacon_enhancement_strategy(program) when is_struct(program) do
    cond do
  ...
  def beacon_enhancement_strategy(_), do: :wrap_optimized
end
