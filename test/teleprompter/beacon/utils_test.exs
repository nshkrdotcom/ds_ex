defmodule DSPEx.Teleprompter.BEACON.UtilsTest do
  ...
  describe "number extraction" do
    ...
    test "handles negative numbers" do
      ...
      # Either extracts 5 or finds no number
      assert result == 5 or result == nil
    end
  end
  ...
  describe "reasoning quality evaluation" do
    test "high quality reasoning with math operations" do
      ...
      # Should get points for math operations and structure
      assert score > 0.1
    end
    ...
    test "identical reasoning gets perfect keyword overlap" do
      ...
      # Perfect keyword match should score well
      assert score > 0.2
    end
    ...
    test "score is bounded to maximum of 0.4" do
      ...
      rich_reasoning =
        "First, calculate 5 × 12 = 60. Then, because this equals our target, therefore the final step gives us the answer."
  ...
  describe "execution time measurement" do
    test "measures successful function execution" do
      result =
        Utils.measure_execution_time(fn ->
          Process.sleep(10)
          {:ok, "test"}
        end)
