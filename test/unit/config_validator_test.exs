defmodule DSPEx.Config.ValidatorTest do
  ...
  describe "path validation" do
    test "validates known configuration paths" do
      ...
      assert :ok = Validator.validate_path([:dspex, :teleprompters, :beacon, :optimization, :max_trials])
    end
  ...
  describe "schema-based value validation" do
    test "validates client configuration values" do
      ...
      assert {:error, :invalid_timeout} = Validator.validate_value([:dspex, :client, :timeout], -1000)
      assert {:error, :invalid_timeout} = Validator.validate_value([:dspex, :client, :timeout], "30000")
      ...
      assert {:error, :invalid_retry_attempts} = Validator.validate_value([:dspex, :client, :retry_attempts], -1)
      assert {:error, :invalid_retry_attempts} = Validator.validate_value([:dspex, :client, :retry_attempts], "3")
      ...
      assert {:error, :invalid_backoff_factor} = Validator.validate_value([:dspex, :client, :backoff_factor], 0)
      assert {:error, :invalid_backoff_factor} = Validator.validate_value([:dspex, :client, :backoff_factor], -1.0)
    end

    test "validates provider configuration values" do
      # Valid API key
      assert :ok = Validator.validate_value([:dspex, :providers, :gemini, :api_key], "valid-api-key")
      assert :ok = Validator.validate_value([:dspex, :providers, :gemini, :api_key], {:system, "GEMINI_API_KEY"})
      
      # Invalid API key
      assert {:error, :invalid_api_key} = Validator.validate_value([:dspex, :providers, :gemini, :api_key], 12345)
      assert {:error, :invalid_api_key} = Validator.validate_value([:dspex, :providers, :gemini, :api_key], nil)

      # Valid base URL
      assert :ok = Validator.validate_value([:dspex, :providers, :openai, :base_url], "https://api.openai.com")
      
      # Invalid base URL  
      assert {:error, :invalid_base_url} = Validator.validate_value([:dspex, :providers, :openai, :base_url], 123)

      # Valid rate limit
      assert :ok = Validator.validate_value([:dspex, :providers, :gemini, :rate_limit, :requests_per_minute], 100)
      
      # Invalid rate limit
      assert {:error, :invalid_rate_limit} = Validator.validate_value([:dspex, :providers, :gemini, :rate_limit, :requests_per_minute], 0)
      assert {:error, :invalid_rate_limit} = Validator.validate_value([:dspex, :providers, :gemini, :rate_limit, :requests_per_minute], "100")
    end
    ...
    test "validates prediction configuration values" do
      ...
      # Invalid provider
      assert {:error, :invalid_provider} = Validator.validate_value([:dspex, :prediction, :default_provider], :invalid_provider)
      assert {:error, :invalid_provider} = Validator.validate_value([:dspex, :prediction, :default_provider], "gemini")
      ...
      # Invalid temperature
      assert {:error, :invalid_temperature} = Validator.validate_value([:dspex, :prediction, :default_temperature], -0.1)
      assert {:error, :invalid_temperature} = Validator.validate_value([:dspex, :prediction, :default_temperature], 2.1)
      assert {:error, :invalid_temperature} = Validator.validate_value([:dspex, :prediction, :default_temperature], "1.0")
      ...
      assert {:error, :invalid_boolean} = Validator.validate_value([:dspex, :prediction, :cache_enabled], "true")
      assert {:error, :invalid_boolean} = Validator.validate_value([:dspex, :prediction, :cache_enabled], 1)
    end

    test "validates BEACON teleprompter configuration values" do
      # Valid optimization settings
      assert :ok = Validator.validate_value([:dspex, :teleprompters, :beacon, :optimization, :max_trials], 10)
      assert :ok = Validator.validate_value([:dspex, :teleprompters, :beacon, :optimization, :improvement_threshold], 0.05)
      
      # Invalid optimization settings
      assert {:error, :invalid_max_trials} = Validator.validate_value([:dspex, :teleprompters, :beacon, :optimization, :max_trials], 0)
      assert {:error, :invalid_improvement_threshold} = Validator.validate_value([:dspex, :teleprompters, :beacon, :optimization, :improvement_threshold], 1.5)

      # Valid Bayesian optimization settings
      assert :ok = Validator.validate_value([:dspex, :teleprompters, :beacon, :bayesian_optimization, :acquisition_function], :expected_improvement)
      assert :ok = Validator.validate_value([:dspex, :teleprompters, :beacon, :bayesian_optimization, :surrogate_model], :gaussian_process)
      
      # Invalid Bayesian optimization settings
      assert {:error, :invalid_acquisition_function} = Validator.validate_value([:dspex, :teleprompters, :beacon, :bayesian_optimization, :acquisition_function], :invalid_function)
      assert {:error, :invalid_surrogate_model} = Validator.validate_value([:dspex, :teleprompters, :beacon, :bayesian_optimization, :surrogate_model], :invalid_model)
    end
    ...
    test "validates logging and telemetry configuration values" do
      ...
      # Invalid log level
      assert {:error, :invalid_log_level} = Validator.validate_value([:dspex, :logging, :level], :invalid_level)
      assert {:error, :invalid_log_level} = Validator.validate_value([:dspex, :logging, :level], "info")
      ...
      assert {:error, :invalid_boolean} = Validator.validate_value([:dspex, :telemetry, :enabled], "true")
      assert {:error, :invalid_boolean} = Validator.validate_value([:dspex, :logging, :correlation_enabled], 1)
    end
  end

  describe "enhanced error reporting" do
    test "provides detailed validation error information" do
      {:error, error_details} = Validator.validate_value_detailed([:dspex, :client, :timeout], "invalid")
    ...
    test "provides helpful suggestions for common errors" do
      ...
      {:error, error_details} = Validator.validate_value_detailed([:dspex, :prediction, :default_temperature], 3.0)
      assert error_details.suggestion =~ "0.0 and 2.0"

      {:error, error_details} = Validator.validate_value_detailed([:dspex, :logging, :level], :invalid)
    ...
    test "returns :ok for valid values in detailed validation" do
      ...
      assert :ok = Validator.validate_value_detailed([:dspex, :prediction, :default_provider], :gemini)
    end
  end
  ...
  describe "backward compatibility" do
    test "maintains same API as legacy validator" do
      ...
      assert :ok = Validator.validate_value([:dspex, :client, :timeout], 30000)
      assert {:error, :invalid_timeout} = Validator.validate_value([:dspex, :client, :timeout], "invalid")
      
      # Ensure error atoms match legacy behavior
      assert {:error, :invalid_timeout} = Validator.validate_value([:dspex, :client, :timeout], 0)
      assert {:error, :invalid_retry_attempts} = Validator.validate_value([:dspex, :client, :retry_attempts], -1)
      assert {:error, :invalid_provider} = Validator.validate_value([:dspex, :prediction, :default_provider], :invalid)
      assert {:error, :invalid_boolean} = Validator.validate_value([:dspex, :telemetry, :enabled], "true")
    end
    ...
    test "legacy validator functions still work" do
      ...
      assert {:error, :invalid_timeout} = Validator.validate_value_legacy([:dspex, :client, :timeout], "invalid")
    end
  end
  ...
  describe "ElixactSchemas integration" do
    test "path to schema mapping works correctly" do
      ...
      assert {:ok, ProviderConfiguration, [:rate_limit, :requests_per_minute]} = ElixactSchemas.path_to_schema([:dspex, :providers, :openai, :rate_limit, :requests_per_minute])

      # BEACON configuration  
      assert {:ok, BEACONConfiguration, [:optimization, :max_trials]} = ElixactSchemas.path_to_schema([:dspex, :teleprompters, :beacon, :optimization, :max_trials])
  ...
  describe "error edge cases" do
    test "handles unknown paths gracefully" do
      assert {:error, {:unknown_path, [:unknown, :path]}} = Validator.validate_value([:unknown, :path], "value")
    end
  ...
  describe "performance characteristics" do
    test "schema validation is reasonably fast" do
      ...
      assert duration_ms < 100, "Schema validation took #{duration_ms}ms for 1000 calls - too slow"
    end
